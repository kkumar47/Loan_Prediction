...
def raw_data():
	return pd.read_csv('https://raw.githubusercontent.com/kkumar47/Loan_Prediction/master/lending_club_loan_two.csv', nrows=5000)
...
with modelg:
	...
	est = st.slider ('Select Number of Estimators', min_value=300,max_value=2500, value=1000, step=50, help='Select Estimator Size' )
